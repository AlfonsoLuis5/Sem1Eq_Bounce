...
public class Main: SEScene
{
	...
	public void initialize(SEResourceCache rsc) 
	{
		...
		rsc.prepare_image("my_image","img1",get_scene_width()*0.1,get_scene_height()*0.1);
		fg = add_sprite_for_image(SEImage.for_resource("my_image"));
		fg.move(100,100);

		/*vg = add_sprite_for_color(Color.instance("blue"),get_scene_width()*0.1,get_scene_height()*0.1);
		vg.move(100,150);*/	
